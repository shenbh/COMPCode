...
import com.newland.comp.view.SwitchButtonAnimationController.OnAnimateListener;
...
public class SwitchButton extends CompoundButton {
	...
	private SwitchButtonAnimationController mAnimationController;
	...
	public SwitchButton(Context context, AttributeSet attrs, int defStyle) {
		...
		mConf.setRadius(ta.getInt(R.styleable.SwitchButton_radius, SwitchButtonConfiguration.Default.DEFAULT_RADIUS));
	...
	private void initView() {
		...
		mAnimationController = SwitchButtonAnimationController.getDefault().init(mOnAnimateListener);
		mBounds = new Rect();
		if (SHOW_RECT) {
	...
	private void fetchDrawableFromAttr(TypedArray ta) {
		...
		mConf.setOffDrawable(fetchDrawable(ta, R.styleable.SwitchButton_offDrawable, R.styleable.SwitchButton_offColor, SwitchButtonConfiguration.Default.DEFAULT_OFF_COLOR));
		mConf.setOnDrawable(fetchDrawable(ta, R.styleable.SwitchButton_onDrawable, R.styleable.SwitchButton_onColor, SwitchButtonConfiguration.Default.DEFAULT_ON_COLOR));
	...
	private Drawable fetchThumbDrawable(TypedArray ta) {
		...
		int normalColor = ta.getColor(R.styleable.SwitchButton_thumbColor, SwitchButtonConfiguration.Default.DEFAULT_THUMB_COLOR);
		int pressedColor = ta.getColor(R.styleable.SwitchButton_thumbPressedColor, SwitchButtonConfiguration.Default.DEFAULT_THUMB_PRESSED_COLOR);
