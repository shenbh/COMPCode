...
import com.newland.comp.adapter.my.MyAttendanceStatisticsBeLateAdapter.ViewHolder;
import com.newland.comp.bean.my.FilingDetailData;
import com.newland.comp.utils.StringUtil;
import com.newland.comp2.R;

public class MyAttendanceStatisticsLeaveEarlyAdapter extends BaseAdapter {
	LayoutInflater inflater;
	List<FilingDetailData> list;
	Context context;

	public MyAttendanceStatisticsLeaveEarlyAdapter(FragmentActivity myAttendanceLeaveActivity, List<FilingDetailData> group_list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.my_attendance_statistics_detail_leaveearly_item, null);
