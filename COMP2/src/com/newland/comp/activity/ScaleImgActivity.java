...
public class ScaleImgActivity extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.scale_img);
		   zoomImg = (ImageView) findViewById(R.id.imageView);
		   String url = getIntent().getStringExtra("url");
		   imageLoader.displayImage(url,zoomImg, options);
		   zoomImg.setOnTouchListener(new TouchListener());
		   TextView center_title = (TextView) findViewById(R.id.head_center_title);
	    	center_title.setText("图片查看");
